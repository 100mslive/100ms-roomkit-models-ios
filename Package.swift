...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "HMSSDK",
            url: "https://github.com/100mslive/100ms-ios-sdk/releases/download/1.8.0/HMSSDK.xcframework.zip",
            checksum: "bb9e0330b0db6c555e669e1529ade0e0e1362ca107b85c1f93910b5239b8f56e"
        ),
        .binaryTarget(
            name: "HMSAnalyticsSDK",
