...
#if !Preview
    public func getIterator(for roleName: String, limit: Int = 10) -> HMSPeerListLoader {
        let iterator = HMSPeerListLoader(iterator: sdk.getPeerListIterator(options: HMSPeerListIteratorOptions(filterByRoleName: roleName, limit: limit))) { [weak self] inPeer in
